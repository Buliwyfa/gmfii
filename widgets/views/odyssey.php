 ...
 *
 * @package humhub.modules.gmfu.widgets.views
 * @since 0.5
 */
?>
...
<div class="panel panel-default" id="groups-statistics-panel">
    ...
    <div class="panel-heading">
        <?php echo Yii::t('GmfuModule.widgets_views_groupStats', '<strong>Group</strong> stats'); ?>
    </div>
    <div class="panel-body">
        <div class="knob-container" style="text-align: center; opacity: 0;">
            <strong><?php echo Yii::t('GmfuModule.widgets_views_groupStats', 'Total groups'); ?></strong><br><br>
        ...
        <div class="knob-container" style="text-align: center; opacity: 0;">
            <strong><?php echo Yii::t('GmfuModule.widgets_views_groupStats', 'Average members'); ?></strong><br><br>
        ...
        <div style="text-align: center;">
            <strong><?php echo Yii::t('GmfuModule.widgets_views_groupStats', 'Top Group'); ?>:</strong> <?php echo $statsTopGroup->name; ?>
        </div>
    </div>
</div>
